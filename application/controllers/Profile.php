    ...
    public function statistics() {
        ...
        if ($data['premium_data']['isPremium'] == NULL) {
            ...
            if (($data['all_services']) == NULL) {
                ...
                switch ($monthYear[0]) {
                    case "1": $monthYear[0] = "Janeiro";
                        break;
                    case "2": $monthYear[0] = "Fevereiro";
                        break;
                    case "3": $monthYear[0] = "Março";
                        break;
                    case "4": $monthYear[0] = "Abril";
                        break;
                    case "5": $monthYear[0] = "Maio";
                        break;
                    case "6": $monthYear[0] = "Junho";
                        break;
                    case "7": $monthYear[0] = "Julho";
                        break;
                    case "8": $monthYear[0] = "Agosto";
                        break;
                    case "9": $monthYear[0] = "Setembro";
                        break;
                    case "10": $monthYear[0] = "Outubro";
                        break;
                    case "11": $monthYear[0] = "Novembro";
                        break;
                    case "12": $monthYear[0] = "Dezembro";
                        break;
                    default: $monthYear[0] = "Unknown";
                        break;
                }
