                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <?php if ($this->session->userdata('logged_in') && $this->session->userdata('logged_in')->ativo == 1): ?>
                                <li><a href="<?= base_url("profile") ?>">Minha Conta</a></li>
                                <li><a href="<?= base_url("logout") ?>">Sair</a></li>
                            <?php elseif ($this->session->userdata('logged_in') && $this->session->userdata('logged_in')->ativo == -1): ?>
                                <li><a href="<?= base_url("logout") ?>">Sair</a></li>
                            <?php else: ?>
