                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
                                ...
                                <?php if (($user_profile->positive_recommendations - $user_profile->negative_recommendations) >= 100 && ($user_profile->positive_recommendations - $user_profile->negative_recommendations) <= 1000): ?>
                                    <img src="<?= base_url("assets/img/crown-bronze.png") ?>" alt="tier" class="tier"/>
                                <?php elseif (($user_profile->positive_recommendations - $user_profile->negative_recommendations) > 1000 && ($user_profile->positive_recommendations - $user_profile->negative_recommendations) <= 5000): ?>
                                    <img src="<?= base_url("assets/img/crown-silver.png") ?>" alt="tier" class="tier"/>
                                <?php elseif (($user_profile->positive_recommendations - $user_profile->negative_recommendations) > 5000 && ($user_profile->positive_recommendations - $user_profile->negative_recommendations) < 10000): ?>
                                        ...
                                        <?php foreach ($services as $key => $service): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir?')" href="<?= base_url("profile/deleteService/{$service->id}"); ?>"><span class="glyphicon glyphicon-remove"></span> Remover</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
