        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <?php echo form_input(array('name' => 'avatar', 'class' => 'form-control', 'id' => 'avatar', 'type' => 'hidden', 'value' => isset($user_profile) ? $user_profile['picture'] : NULL)); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?php echo form_dropdown(array('class' => 'selectpicker', 'data-live-search' => 'true', 'data-width' => '100%', 'name' => 'selectState', 'id' => 'selectState'), $states); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <?php echo form_label('Cidade', 'name', array('class' => 'col-md-3 control-label')); ?>
                        <div class="col-md-9">
                            <?php echo form_dropdown(array('class' => 'selectpicker', 'data-live-search' => 'true', 'data-width' => '100%', 'name' => 'selectCity', 'id' => 'selectCity'), $citys); ?>
                        </div>
                    </div>
                    <div class="form-group">
