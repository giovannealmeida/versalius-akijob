...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-4">
        <form action="<?= base_url("subscribe/redeem") ?>" method="post" data-toggle="validator">
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        <label for="code">Insira o código promocional</label>
                        <input type="input" class="form-control" id="code" placeholder="Código Promocional" name="code" required="true">
