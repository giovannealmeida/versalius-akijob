        ...
        <div class="navbar navbar-custom navbar-fixed-top">
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <form class="navbar-form navbar-left" action="<?= base_url("results") ?>" method="post" data-toggle="validator">
                        <div class="form-group search-navbar">
                            <label class="sr-only" for="selectJob">Serviços</label>
                            <?php echo form_dropdown(array('class' => "selectpicker with-ajax", "data-abs-log" => "false", 'data-live-search' => "true", 'data-width' => "100%", 'name' => "selectJob", 'id' => "selectJob", "required" => "true")); ?>
                        </div>
                        <div class="form-group search-navbar">
                            <label class="sr-only" for="selectCity ">Cidade</label>
                            <?php echo form_dropdown(array('class' => "selectpicker with-ajax", "data-abs-log" => "false", 'data-live-search' => "true", 'data-width' => "100%", 'name' => "selectCity", 'id' => "selectCity", "required" => "true")); ?>
                        </div>
